$(function(){
    ...
    $('#dg_nasabah_jiwa').datagrid({
        title : 'FORM POLIS JIWA',
        fitColumns : true,
        url : "content/form_polis_jiwa/master_data_nasabah.php",
        height : hTbl,
        method:'post',
        queryParams : {
...
function ProsesPolisJiwa(){
    ...
    $('body').find('#form_polis_jiwa').remove();
    $('<div/>').attr('id','form_polis_jiwa').appendTo($('body')).dialog({
        href : 'content/form_polis_jiwa/form_polis_jiwa.php',
        width : 800,
        height : hTbl,
        top : 15,
        position : 'center',
        ...
        buttons: [{
            ...
            iconCls:'icon-cancel',
            handler:function(){
                $('#form_polis_jiwa').dialog('close').dialog('destroy');
            }
        }]
    });
}
