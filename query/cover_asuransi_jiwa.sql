SELECT DISTINCT
a.kode_kantor, d.no_id, b.no_ktp, d.nama_nasabah, f.nama_area_kerja, d.tempatlahir, d.tgllahir, d.alamat, h.ktp_alamat, h.ktp_rt,
...
INNER JOIN dpm_online.css_kode_dati AS g ON g.kode_dari = d.kota_kab
INNER JOIN dpm_online.nasabah_alamat AS h ON h.nasabah_id = d.nasabah_id
INNER JOIN dpm_online.css_kode_provinsi AS i ON h.ktp_propinsi = i.kode_provinsi
