...
if($kategori==1){
    $nama_kategori = "UP. MENURUN";
    $type_kredit = " and a.type_kredit IN ('700') ";
}elseif($kategori==2){
    $nama_kategori = "UP. TETAP";
    $type_kredit = " and a.type_kredit NOT IN ('700') ";
}
...
$objPHPExcel->getActiveSheet()->setCellValue('A1','NAMA BANK : '.$nama_perusahaan);
$objPHPExcel->getActiveSheet()->setCellValue('A2','CABANG : '.$cabang);
$objPHPExcel->getActiveSheet()->setCellValue('A3','JENIS UANG PERTANGGUNGAN : '.$nama_kategori);
$objPHPExcel->getActiveSheet()->setCellValue('A4','DAFTAR PESERTA SEMENTARA');
$objPHPExcel->getActiveSheet()->setCellValue('A5','LAMPIRKAN SPAJ');
$objPHPExcel->getActiveSheet()->setCellValue('A6','PEMEGANG POLIS : '.$nama_perusahaan);
$objPHPExcel->getActiveSheet()->setCellValue('A7','ALAMAT : '.$alamat_perusahaan);
$objPHPExcel->getActiveSheet()->setCellValue('A8','MACAM ASURANSI : KREDIT KONSUMTIF '.$nama_kategori);
...
$query = "SELECT DISTINCT
    ...
    WHERE b.kode_asuransi = '005' $type_kredit and b.created_date like '%$periode_awal%'
