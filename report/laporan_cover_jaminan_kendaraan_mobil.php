...
$objPHPExcel->getActiveSheet()->setCellValue('C5', 'TLO');
$objPHPExcel->getActiveSheet()->setCellValue('D5', 'No rekening');
$objPHPExcel->getActiveSheet()->setCellValue('E5', 'Nama nasabah');
$objPHPExcel->getActiveSheet()->setCellValue('F5', 'Lama cover');
$objPHPExcel->getActiveSheet()->setCellValue('G5', 'Nilai pertanggungan');
$objPHPExcel->getActiveSheet()->setCellValue('H5', 'Spesifikasi kendaraan');
$objPHPExcel->getActiveSheet()->setCellValue('H6', 'Merk / Type');
$objPHPExcel->getActiveSheet()->setCellValue('I6', 'Tahun');
$objPHPExcel->getActiveSheet()->setCellValue('J6', 'Warna');
$objPHPExcel->getActiveSheet()->setCellValue('K6', 'No. Polisi');
$objPHPExcel->getActiveSheet()->setCellValue('L6', 'No. Rangka');
$objPHPExcel->getActiveSheet()->setCellValue('M6', 'No. Mesin');

$objPHPExcel->getActiveSheet()->mergeCells('A1:M1');
$objPHPExcel->getActiveSheet()->mergeCells('A2:M2');
$objPHPExcel->getActiveSheet()->mergeCells('A3:M3');
$objPHPExcel->getActiveSheet()->mergeCells('A4:M4');
$objPHPExcel->getActiveSheet()->mergeCells('H5:M5');
...
$objPHPExcel->getActiveSheet()->getStyle('H5:M5')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
$query = "SELECT a.kode_kantor, b.no_rekening, a.tgl_realisasi, a.tgl_jatuh_tempo, d.nama_nasabah,
    ...
    c.no_rangka, c.no_mesin, c.warna, c.tahun, c.no_polisi, c.alamat_bpkb, b.selisih, b.kode_pertanggungan, f.nama_pertanggungan
...
while($d= mysqli_fetch_assoc($ex_query)){
    ...
    $nama_pertanggungan = $d['nama_pertanggungan'];
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('J'.$n, $warna);
    $objPHPExcel->getActiveSheet()->setCellValue('K'.$n, $no_polisi);
    $objPHPExcel->getActiveSheet()->setCellValue('L'.$n, $no_rangka);
    $objPHPExcel->getActiveSheet()->setCellValue('M'.$n, $no_mesin);

    $objPHPExcel->getActiveSheet()->getStyle('G'.$n)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
